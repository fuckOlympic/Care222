...
{    	 
 ...
 /***********************************************************/
  ...
  GPIO_ResetBits(GPIOB,GPIO_Pin_14);//GPIOB14设置高，灯亮G
  GPIO_SetBits(GPIOB,GPIO_Pin_15);//GPIOB15设置高，灯亮B
 /***********************************************************/
#endif
...
/************************************************************/  
 //初始化PC5，PC10为输出口.并使能这两个口的时钟	D5,D6指示灯 
  ...
  GPIO_SetBits(GPIOC,GPIO_Pin_5|GPIO_Pin_10);//GPIOC5&GPIO10设置高
