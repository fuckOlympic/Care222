...
//本产品使用的是24Lc64，所以定义EE_TYPE为AT24LC64
...
void AT24CXX_Write(u16 WriteAddr,u16 *pBuffer,u16 NumToWrite);	//从指定地址开始写入指定长度的数据
void AT24CXX_Read(u16 ReadAddr,u16 *pBuffer,u16 NumToRead);   	//从指定地址开始读出指定长度的数据
