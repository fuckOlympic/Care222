...
uint32_t USBD_OTG_ISR_Handler (USB_OTG_CORE_HANDLE *pdev)
{
  ...
  if (USB_OTG_IsDeviceMode(pdev)) /* ensure that we are in device mode */
  {
    ...
    {
//			printf("USBD_OTG_ISR_Handler: OutEP_ISR %x\r\n",gintr_status.d32);
      retval |= DCD_HandleOutEP_ISR(pdev);
    }    
    
    if (gintr_status.b.inepint)
    {
//			printf("USBD_OTG_ISR_Handler: InEP_ISR %x\r\n",gintr_status.d32);
    ...
    {
//			printf("USBD_OTG_ISR_Handler: Suspend_ISR %x\r\n",gintr_status.d32);
      retval |= DCD_HandleUSBSuspend_ISR(pdev);
    }
    if (gintr_status.b.sofintr)
    {
//			printf("USBD_OTG_ISR_Handler: Sof_ISR %x\r\n",gintr_status.d32);
    ...
    {
//			printf("USBD_OTG_ISR_Handler: UsbReset_ISR %x\r\n",gintr_status.d32);
